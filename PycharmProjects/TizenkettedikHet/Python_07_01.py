...
#főprogram
uresfa=BinaryTree() # üres bináris fa létrehozása uresfa néven
if uresfa.isEmpty():
    print("\nEz a binfa üres.")
fa=BinaryTree("alma") # fa nevű egyelemű fa, a gyökérelem az „alma” szót tartalmazza
if fa.isEmpty(): # ha üres a fa:
    print("Ez a binfa üres.")
else: # különben:
    print("Ez a binfa nem üres.")
print("A gyökérelem:", fa.root)# gyökérelem kiírása
print("Az aktuális elem:",fa.act)# aktuális elem kiírása
...
print("Az aktuális elem most:", fa.act)# aktuális elem kiírása