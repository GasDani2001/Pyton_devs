...
binfa.Next("balra") # a gyökértől "lelépünk" balra
binfa.Next("balra") # megint "lelépünk" balra, a 23-hoz jutunk
print("\nAz akt mutató most erre mutat: ",binfa.act)
binfa.insertBinTree(BinaryTree(100),"jobbra") # jobbgyerekének beszúrjuk a 100-at
binfa.insertBinTree(BinaryTree(1), "balra") # balgyerekének az 1-et
...
binfa.Next("balra") # a 19-re állunk ezzel
reszfa=BinaryTree() #üres binfa létrehozása
binfa.removeBinTree(reszfa, "jobbra") # leválasztjuk a 19-es csomópont jobbgyerekét
print("\nA leválasztott részfa:")
reszfa.printBinTree()
print("\nA maradék bináris fa:")
binfa.printBinTree()
binfa.Top() # elejére (gyökérre) állunk
binfa.Next("jobbra") # a 15-ös az aktuális
binfa.insertBinTree(reszfa, "jobbra") # 15 jobbgyerekének beillesztjük a leválasztott részfát
