...
#főprogram
print("")
kerfa = BinarySearchTree() # üres keresőfa kerfa néven
kerfa.Insert("körte") # "körte" elem beillesztése
kerfa.Insert("alma") # "alma" elem beillesztése
kerfa.Insert("barack") # "barack" elem beillesztése
kerfa.Insert("cseresznye") # "cseresznye" elem beillesztése
