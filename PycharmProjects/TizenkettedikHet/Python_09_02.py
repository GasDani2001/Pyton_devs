...
graf.addVertex("10") # a 10-es csúcspont hozzáadása
print("A 10-es csúcspontnak nincsenek szomszédjai:")
print(graf.Neighbors("10")) # a 10-es csúcspont szomszédai (üres lista lesz)
print("\nA 3-as csúcspont szomszédjai:")
print(graf.Neighbors("3"))
print("\nFelvesszük a gráfba a (10,5) élt.")
graf.addEdge("10", "5", False) # a (10,5) él hozzáadása
print("A gráf élei most: ",graf.getEdges(False))
if graf.isEdge("0","3"): # ha a (0,3) él a gráfban:
    print("\nTöröltük a gráfból a (0,3) élt.")
    graf.removeEdge("0", "3", False) # a (0,3) él törlése
else:
    print("A gráfnak a (0,3) nem éle.")
print("A gráf élei most: ",graf.getEdges(False))
if graf.isEdge("3", "1"): # ha a (3,1) él a gráfban
