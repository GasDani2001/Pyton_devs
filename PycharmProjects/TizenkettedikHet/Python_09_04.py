...
print("\nA gráf csúcspontjai a mélységi bejárás szerint (a 0. csúcstól indulva):")
graf.DepthFirstTraversal("0")
print("\nA gráf csúcspontjai a rekurzív mélységi bejárás szerint (a 0. csúcstól indulva):")
graf.rec_DepthFirst("0") 
