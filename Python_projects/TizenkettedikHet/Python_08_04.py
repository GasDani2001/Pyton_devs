...
from Python_07_05 import BinaryTree
...
kerfa.Delete("cseresznye") # "cseresznye" elem törlése
...
kerfa.Delete("barack") # "barack" elem törlése
kerfa.Delete("szilva") # "szilva" elem törlése
kerfa.printBinTree()
kfa=BinarySearchTree() # üres bináris keresőfa létrehozása kfa néven
print()
kfa.Delete("alma") # "alma" elem törlése a kfa fából
